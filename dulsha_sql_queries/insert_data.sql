...
VALUES ("1","TG/2024/2107","Dulsha","Hemini","Hettivitharana","dulshahemini@gmail.com","0772527917","Female","Kekanadura,Matara","200520257730","2004-09-28","ACTIVE","2025-01-03","1","1","2","9");

--insert data into medical
INSERT INTO medical(medical_id, medical_reason,medical_ref_no,submit_at,stu_id,course_code) 
VALUES ("1","Fever","ME123456789","2025-01-03 19:50:00" , "1","ICT1112");

--insert data into complains
INSERT INTO complains(complain_id,subject,complain_type,reason,create_time,stu_id,status)
VALUES ("1","Attendance issue","Attendance","My attendance for DBMS on 2025-03-12 is marked absent but I was present." ,"2025-01-03 19:50:00" , "1","PENDING")

--insert data into attendence_n
INSERT INTO attendence_n(stu_id,course_code,lec_day,daytime,attendence)
VALUES ("1","ICT1112","1","2025-01-01 08:00:00","ABSENT");
